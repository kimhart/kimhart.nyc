...
export default class Sunset extends React.Component {
  ...
  handleClick = () => this.props.onClick && this.props.onClick('sunset');

  render() {
    const { theme } = this.props;

    return (
      <div className="theme-toggle -sunset" onClick={this.handleClick}>
        <svg
        ...
        >
          ...
          >
            <g
              ...
              stroke={theme === "sunset" ? "#FFFD9A" : "#212229"}
              strokeWidth="2"
            >
                ...
                <g id="Group-15" transform="translate(124.000000, 6.000000)">
                  <g id="Group-14">
                    ...
                    <path
                      ...
                      id="Stroke-12"
                      stroke={theme === "sunset" ? "#FFFFFF" : "#212229"}
                    />
                    <path
